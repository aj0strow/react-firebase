    ...
    var Sync = function (_Component) {
      ...
      _createClass(Sync, [{
        ...
        value: function componentWillMount() {
          ...
          keys(mapFirebaseToProps(this.props)).forEach(function (key) {
        ...
        value: function setFirebase(key, value) {
          if (value) {
            var firebase = assign({}, this.state.firebase, _defineProperty({}, key, value));
        ...
        value: function subscribeKey(key) {
          ...
          var callback = function callback(snap) {
            _this4.setFirebase(key, snap.val());
          };
